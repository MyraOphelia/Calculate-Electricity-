...
public class FinalEAssignment2020 {
    ...
    public static void main(String[] args) {
        ...
        greet=new JFrame();
         JOptionPane.showMessageDialog(greet, "Welcome to TNB Calculate Bill ",
            "Hi, Welcome  ", JOptionPane.INFORMATION_MESSAGE);
        name=new JFrame();
          String  Name = JOptionPane.showInputDialog(name, "What's your name?");
          JOptionPane.showMessageDialog(name, "Nice to meet you , gucci gang  " + Name );
